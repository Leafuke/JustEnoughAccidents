...
public final class IncidentNotifier implements IncidentFeedback {
    ...
    private ServerPlayer owner() {
        ...
        return profile == null ? null : server.getPlayerList().getPlayer(profile.getId());
    }
    ...
    private void sendRestoreButtonToOwner(BackupId backupId) {
        ...
        String command = "/mb restore " + escapeIfRequired(backupId.value());
    ...
    private static String escapeIfRequired(String value) {
        if (StringReader.isAllowedInUnquotedString(value.charAt(0))) {
